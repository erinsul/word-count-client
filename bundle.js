...
/***/ function(module, exports, __webpack_require__) {
	...
	var projectEvents = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().done(ui.signOutSuccess);
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://word-page-count-deadlines.herokuapp.com/'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var projects = __webpack_require__(8);
	...
	var displayWelcome = function displayWelcome(user) {
	  var welcomeTemplate = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateProject = function onCreateProject(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createProject(data).done(ui.createSuccess).fail(ui.createFail);
	};

	var onShowProjects = function onShowProjects() {
	  event.preventDefault();
	  api.showProjects().done(ui.displayProjects);
	};

	var onProjectDetails = function onProjectDetails() {
	  event.preventDefault();
	  api.showProjectDetails($(event.target).data('id')).done(ui.displayProjectDetails);
	};

	var onProjectDelete = function onProjectDelete() {
	  event.preventDefault();
	  api.deleteProject($(event.target).data('id')).done($(event.target).parent().remove());
	};

	var onProjectUpdate = function onProjectUpdate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateProject(data, $(event.target).data('id')).success(onProjectDetails()).fail(ui.updateDateFailWarning);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showProjectDetails = function showProjectDetails(id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayProjects = function displayProjects(projects) {
	  var titleListingTemplate = __webpack_require__(32);
	  $('#content').html(titleListingTemplate(projects));
	  $('#show').hide();
	  $('#create').show();
	};

	var displayProjectDetails = function displayProjectDetails(project) {
	  ...
	  var projectDisplay = __webpack_require__(33);
	  $('#content').html(projectDisplay(project));
	  $('#show').show();
	  $('#create').hide();
	};

	var displayDelete = function displayDelete() {
	  $('').hide();
	};
	...
	module.exports = {
	  ...
	  updateDateFailWarning: updateDateFailWarning
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"title","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.project : depth0), depth0),{"name":"project","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <h1>"
	    ...
	    + "</p></li>\n      <li class><p class=\"form\">Update your deadline:</p>\n      <form class=\"update\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n        <fieldset>\n          <input type=\"date\" name=\"projects[end_date]\" placeholder=\"target end date (yyyy-mm-dd)\">\n          <input type=\"submit\" name=\"submit\" value=\"Update\">\n        </fieldset>\n      </form>\n      <p class = \"error-message\"></p>\n      </li>\n      <li><p>Days left: "
	    + alias4(((helper = (helper = helpers.days_left || (depth0 != null ? depth0.days_left : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"days_left","hash":{},"data":data}) : helper)))
	    + "</p></li>\n      <li><p>Current "
	    ...
	    + " count: "
	    + alias4(((helper = (helper = helpers.current_count || (depth0 != null ? depth0.current_count : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"current_count","hash":{},"data":data}) : helper)))
	    + "</p></li>\n      <li><p class=\"form\">Update your "
	    + alias4(((helper = (helper = helpers.counter || (depth0 != null ? depth0.counter : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"counter","hash":{},"data":data}) : helper)))
	    + " count:</p>\n      <form class=\"update\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n        <fieldset>\n          <input type=\"text\" name=\"projects[current_count]\" placeholder=\"current count\">\n          <input type=\"submit\" name=\"submit\" value=\"Update\">\n        </fieldset>\n      </form>\n      </li>\n      <li><p class=\"form\">Change your total goal:</p>\n      <form class=\"update\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n        <fieldset>\n          <input type=\"text\" name=\"projects[total_count]\" placeholder=\"total goal\">\n            <label for=\"page\"> <input type=\"radio\" name = \"projects[counter]\" value=\"page\" checked=checked/> pages</label>\n            <label for=\"word\"> <input type=\"radio\" name = \"projects[counter]\" value=\"word\"/> words</label>\n          <input type=\"submit\" name=\"submit\" value=\"Update\">\n        </fieldset>\n      </form>\n      </li>\n      <li><p>Total "
	    + alias4(((helper = (helper = helpers.counter || (depth0 != null ? depth0.counter : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"counter","hash":{},"data":data}) : helper)))
	    + "s remaining: "
	    + alias4(((helper = (helper = helpers.amount_remaining || (depth0 != null ? depth0.amount_remaining : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"amount_remaining","hash":{},"data":data}) : helper)))
	    + "</p></li>\n      <li><p>You need to do "
	    + alias4(((helper = (helper = helpers.amount_per_day || (depth0 != null ? depth0.amount_per_day : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"amount_per_day","hash":{},"data":data}) : helper)))
	    + " "
	    + alias4(((helper = (helper = helpers.counter || (depth0 != null ? depth0.counter : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"counter","hash":{},"data":data}) : helper)))
	    + "s per day to finish on time.</p></li>\n    </ul>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = "";

	  stack1 = ((helper = (helper = helpers.project || (depth0 != null ? depth0.project : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"project","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.project) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
